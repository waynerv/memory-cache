...
class BaseConfig(object):
    ...
    APP_ADMIN_EMAIL = os.getenv('APP_ADMIN_EMAIL' ,'memorycache@admin.com')
    ...
    APP_USER_PER_PAGE = 20
    APP_COMMENT_PER_PAGE = 15
    APP_NOTIFICATION_PER_PAGE = 20
    APP_SEARCH_RESULT_PER_PAGE = 12
    APP_MANAGE_USER_PER_PAGE = 20
    APP_MANAGE_PHOTO_PER_PAGE = 20
    APP_MANAGE_TAG_PER_PAGE = 20
    APP_MANAGE_COMMENT_PER_PAGE = 30
